...
int initialize_network_modelp() {
    cout << "Creating network architecture..." << endl;
    network = Network();

    network.add(new FCLayer(n_features, 1000));  // Add fully connected layer with 3 inputs and 4 outputs
    network.add(new ActivationLayer(tanh_1, tanh_prime, "tanh_1"));
    network.add(new FCLayer(1000, 1500));  // Add fully connected layer with 3 inputs and 4 outputs
    network.add(new ActivationLayer(relu, relu_prime, "relu")); // Add activation layer with sigmoid
    network.add(new FCLayer(1500, 1000));  // Add fully connected layer with 3 inputs and 4 outputs
    network.add(new ActivationLayer(relu, relu_prime, "relu")); // Add activation layer with sigmoid
    network.add(new FCLayer(1000, 500));  // Add fully connected layer with 3 inputs and 4 outputs
    network.add(new ActivationLayer(tanh_1, tanh_prime, "tanh")); // Add activation layer with sigmoid
    network.add(new FCLayer(500, 250));  // Add fully connected layer with 3 inputs and 4 outputs
    network.add(new ActivationLayer(tanh_1, tanh_prime, "tanh")); // Add activation layer with sigmoid
    network.add(new FCLayer(250, 2));  // Add fully connected layer with 3 inputs and 4 outputs
    network.add(new ActivationLayer(tanh_1, tanh_prime, "tanh")); // Add activation layer with sigmoid
    network.use(mse, mse_prime);
    cout << "Finished creating network architecture..." << endl;
